...
class CbbDataPipeline(object):
  ...
  def process_item(self, item, spider):
    ...
    c.execute("""INSERT IGNORE INTO players (pid,name) VALUES (%s, %s,%s)""",
    ...
    c.execute("""INSERT IGNORE INTO playerstats (pid,gid,tid,pos,min,fgm,fga,tpm,tpa,ftm,fta,oreb,dreb,reb,ast,stl,blk,turnovers,pf,pts) VALUES (%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s)""",
              (item['playerid'], item['gameid'],item['teamid'],item['pos'], item['min'],item['fgm'], item['fga'],item['tpm'], item['tpa'],item['ftm'], item['fta'],item['oreb'], item['dreb'],item['reb'], item['ast']\
